...
async function getDailyReport(e) {
  try {
    ...
    res.data.forEach((expense) => {
      ...
      td1.appendChild(document.createTextNode(expense.expenseCategory));

      const td2 = document.createElement("td");
      td2.appendChild(document.createTextNode(expense.expenseDescription));

      const td3 = document.createElement("td");
      td3.appendChild(document.createTextNode(expense.expenseAmount));
